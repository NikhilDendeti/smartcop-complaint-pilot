  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-medium">AI-Powered Police Complaint Assistant</p>
                </div>
              </div>
        ...
        <div className="relative z-10 container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-full mb-6">
              ...
              <span className="text-blue-700 font-medium text-sm">Next-Generation Complaint System</span>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-white/70 backdrop-blur-sm border-0 shadow-xl">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-bold text-gray-900">Voice Input</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 leading-relaxed">Speak your complaint in Telugu, Hindi, or English. Our AI transcribes and understands your concern.</p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-white/70 backdrop-blur-sm border-0 shadow-xl">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-bold text-gray-900">AI Legal Drafting</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 leading-relaxed">Get professionally drafted complaints with relevant IPC sections suggested automatically.</p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-white/70 backdrop-blur-sm border-0 shadow-xl">
              ...
              <CardContent>
                <p className="text-gray-600 leading-relaxed">Track your complaint status, assigned officers, and get updates throughout the investigation process.</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg">Select your portal to get started with SmartCopAI</p>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="group cursor-pointer hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 bg-gradient-to-br from-white to-blue-50/50 backdrop-blur-sm border-0 shadow-xl overflow-hidden relative" 
                ...
                <CardHeader className="text-center relative z-10 pb-6">
                  <div className="mx-auto mb-6 p-6 bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl shadow-xl group-hover:scale-110 transition-transform duration-300">
                    <Users className="h-12 w-12 text-white" />
                  </div>
                  <CardTitle className="text-2xl font-bold text-gray-900">Citizen Portal</CardTitle>
                </CardHeader>
                <CardContent className="relative z-10">
                  ...
                  <Button className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-lg py-6 text-lg font-semibold rounded-xl">
                    Enter as Citizen
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card className="group cursor-pointer hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 bg-gradient-to-br from-white to-orange-50/50 backdrop-blur-sm border-0 shadow-xl overflow-hidden relative"
                ...
                <CardHeader className="text-center relative z-10 pb-6">
                  <div className="mx-auto mb-6 p-6 bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl shadow-xl group-hover:scale-110 transition-transform duration-300">
                    <Shield className="h-12 w-12 text-white" />
                  </div>
                  <CardTitle className="text-2xl font-bold text-gray-900">Police Officer Portal</CardTitle>
                </CardHeader>
                <CardContent className="relative z-10">
                  <ul className="space-y-3 text-gray-600 mb-6">
                    <li className="flex items-center">
                  ...
                  <Button className="w-full bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white shadow-lg py-6 text-lg font-semibold rounded-xl">
                    Enter as Officer
                  </Button>
                </CardContent>
              </Card>
          ...
          {/* Stats Section */}
          <div className="mt-20 bg-white/70 backdrop-blur-sm rounded-3xl shadow-2xl p-12 border-0">
            <h3 className="text-3xl font-bold text-center mb-12 text-gray-900">Platform Statistics</h3>
            <div className="grid md:grid-cols-4 gap-8 text-center">
              <div className="group">
                <div className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-300">1,247</div>
                <div className="text-gray-600 font-medium">Complaints Filed</div>
              </div>
              <div className="group">
                <div className="text-4xl font-bold bg-gradient-to-r from-green-600 to-green-700 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-300">892</div>
                <div className="text-gray-600 font-medium">Cases Resolved</div>
              </div>
              <div className="group">
                <div className="text-4xl font-bold bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-300">3</div>
                <div className="text-gray-600 font-medium">Languages Supported</div>
              </div>
              <div className="group">
                <div className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-purple-700 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-300">24/7</div>
                <div className="text-gray-600 font-medium">AI Assistance</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Footer */}
        <footer className="relative z-10 bg-gradient-to-r from-gray-900 to-gray-800 text-white py-12 mt-20">
          <div className="container mx-auto px-4 text-center">
            <p className="text-lg mb-2">&copy; 2024 SmartCopAI - Government of India. All rights reserved.</p>
            <p className="text-gray-400">Powered by AI for transparent and efficient policing</p>
          </div>
        </footer>
      </div>
    );
